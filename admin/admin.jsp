            ...
            <ul class="settingnavbar">
                <li class="dropdown"><a href="javascript:void(0)" class="dropbtn">인적관리</a>
                    <div class="dropdown-content">
                        <a href="javascript:void(0)" onclick="loadContent('/employee-create')">직원 생성</a>
                        <a href="javascript:void(0)" onclick="loadContent('/employee-view')">직원 조회/수정/퇴사</a>
                    </div>
                </li>
                <li class="dropdown"><a href="javascript:void(0)" class="dropbtn" onclick="loadContent('/medical-view')">진료조회</a></li>
            </ul>
            <div class="profile-info">
                <img id="profile-image" src="/static/img/jisoo.png" alt="Profile Image">
