...
public class PrescriptionService extends AbstractApiService<PrescriptionDTO> {
    ...
    public PrescriptionService(@Value("${emr.api.key}") String apiKey, @Value("${emr.api.prescription.url}") String apiBaseUrl,  PrescriptionRepository prescriptionRepository) {
