...
public class PatientController {
    ...
    public ResponseEntity<PatientDTO> registerPatient(@RequestBody PatientDTO patientDTO) {
        ...
        // 환자 등록 
        PatientEntity savedPatient = patientService.registerPatient(patientDTO);
        log.info("저장된 환자 : {}\n", savedPatient);
    ...
    public ResponseEntity<List<PatientDTO>> searchPatientsByName(@RequestParam String name) {
        ...
        List<PatientEntity> patients = patientRepository.findByNameContaining(name);
    ...
    public ResponseEntity<String> registerPatientVisit(@RequestBody PatientDTO patientVisitDTO) {
        ...
        PatientEntity patient = patientRepository.findByNameAndSecurityNum(
