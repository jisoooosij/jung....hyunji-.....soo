            ...
            <ul class="settingnavbar">
                <li class="dropdown"><a href="javascript:void(0)" class="dropbtn">인적관리</a>
                    <div class="dropdown-content">
                        <a href="javascript:void(0)" onclick="loadContent('/admin/employeeCreate')">직원 생성</a>
                        <a href="javascript:void(0)" onclick="loadContent('/admin/employeeView')">직원 조회/수정/퇴사</a>
                    </div>
                </li>
